...
func NewTransaction(nonce, blockLimit uint64, to common.Address, amount *big.Int, gasLimit uint64, gasPrice *big.Int, data []byte, chainId int64, groupId int64, extraData []byte) *Transaction {
	return newTransaction(nonce, blockLimit, &to, amount, gasLimit, gasPrice, data, chainId, groupId, extraData)
}

func NewContractCreation(nonce, blockLimit uint64, amount *big.Int, gasLimit uint64, gasPrice *big.Int, data []byte, chainId int64, groupId int64, extraData []byte) *Transaction {
