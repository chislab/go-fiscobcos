...
import (
	...
	"github.com/chislab/go-fiscobcos/cmd/utils"
...
var (
	...
	abiFlag = cli.StringFlag{
		Name:  "abi",
		Usage: "Path to the FiscoBcos contract ABI json to bind, - for STDIN",
	}
	binFlag = cli.StringFlag{
		Name:  "bin",
		Usage: "Path to the FiscoBcos contract bytecode (generate deploy method)",
	}
	...
	solFlag = cli.StringFlag{
		Name:  "sol",
		Usage: "Path to the FiscoBcos contract Solidity source to build and bind",
	}
	...
	vyFlag = cli.StringFlag{
		Name:  "vy",
		Usage: "Path to the FiscoBcos contract Vyper source to build and bind",
	}
...
func init() {
	app = utils.NewApp(gitCommit, gitDate, "fiscobcos checkpoint helper tool")
	app.Flags = []cli.Flag{
		abiFlag,
		binFlag,
		typeFlag,
