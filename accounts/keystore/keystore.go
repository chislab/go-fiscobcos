...
// See https://github.com/fiscobcos/wiki/wiki/Web3-Secret-Storage-Definition for more information.
package keystore
...
// ImportPreSaleKey decrypts the given FiscoBcos presale wallet and stores
