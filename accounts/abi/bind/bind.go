...
// Package bind generates FiscoBcos contract Go bindings.
//
// Detailed usage document and tutorial available on the go-fiscobcos Wiki page:
// https://github.com/chislab/go-fiscobcos/wiki/Native-DApps:-Go-bindings-to-FiscoBcos-contracts
package bind
