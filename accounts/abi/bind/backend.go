...
type PendingContractCaller interface {
	...
	// PendingCallContract executes an FiscoBcos contract call against the pending state.
	PendingCallContract(ctx context.Context, call fiscobcos.CallMsg) ([]byte, error)
}
