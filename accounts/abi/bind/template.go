...
import "github.com/chislab/go-fiscobcos/accounts/abi"
...
{{range $contract := .Contracts}}
	...
	{{if .InputBin}}
		...
		// Deploy{{.Type}} deploys a new FiscoBcos contract, binding an instance of {{.Type}} to it.
		func Deploy{{.Type}}(auth *bind.TransactOpts, backend bind.ContractBackend {{range .Constructor.Inputs}}, {{.Name}} {{bindtype .Type $structs}}{{end}}) (common.Address, *types.Transaction, *{{.Type}}, error) {
		  ...
		  return address, tx, &{{.Type}}{ {{.Type}}Caller: {{.Type}}Caller{contract: contract}, {{.Type}}Transactor: {{.Type}}Transactor{contract: contract}, {{.Type}}Filterer: {{.Type}}Filterer{contract: contract}, ABI: parsed }, nil
		}
	{{end}}

	// {{.Type}} is an auto generated Go binding around an FiscoBcos contract.
	type {{.Type}} struct {
	...
	// {{.Type}}Transactor is an auto generated write-only Go binding around an FiscoBcos contract.
	type {{.Type}}Transactor struct {
	  contract *bind.BoundContract // Generic contract wrapper for the low level calls
	}

	// {{.Type}}Filterer is an auto generated log filtering Go binding around an FiscoBcos contract events.
	type {{.Type}}Filterer struct {
	  contract *bind.BoundContract // Generic contract wrapper for the low level calls
	}

	// {{.Type}}Session is an auto generated Go binding around an FiscoBcos contract,
	...
	// {{.Type}}CallerSession is an auto generated read-only Go binding around an FiscoBcos contract,
	...
	// {{.Type}}TransactorSession is an auto generated write-only Go binding around an FiscoBcos contract,
	...
	// {{.Type}}Raw is an auto generated low-level Go binding around an FiscoBcos contract.
	type {{.Type}}Raw struct {
	  Contract *{{.Type}} // Generic contract binding to access the raw methods on
	}

	// {{.Type}}CallerRaw is an auto generated low-level read-only Go binding around an FiscoBcos contract.
	type {{.Type}}CallerRaw struct {
		Contract *{{.Type}}Caller // Generic read-only contract binding to access the raw methods on
	}

	// {{.Type}}TransactorRaw is an auto generated low-level write-only Go binding around an FiscoBcos contract.
	...
	func New{{.Type}}(address common.Address, backend bind.ContractBackend) (*{{.Type}}, error) {
	  ...
	  return &{{.Type}}{ {{.Type}}Caller: {{.Type}}Caller{contract: contract}, {{.Type}}Transactor: {{.Type}}Transactor{contract: contract}, {{.Type}}Filterer: {{.Type}}Filterer{contract: contract}, ABI: parsed }, nil
	}
...
{{if not .Library}}public {{end}}class {{.Type}} {
	...
	// deploy deploys a new FiscoBcos contract, binding an instance of {{.Type}} to it.
	...
	// FiscoBcos address where this contract is located at.
	public final Address Address;

	// FiscoBcos transaction in which this contract was deployed (if known!).
